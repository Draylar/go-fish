...
public class GoFishItems {
    ...
    // Item Group
    public static final RegistryKey<ItemGroup> GOFISH_ITEM_GROUP = RegistryKey.of(RegistryKeys.ITEM_GROUP, GoFish.id("group"));

    public static final Item BLAZE_ROD = register("blaze_rod", new ExtendedFishingRodItem.Builder().durability(125).autosmelt().lavaProof(true).build());

    public static final Item SKELETAL_ROD = register("skeletal_rod",
            new ExtendedFishingRodItem.Builder().durability(75).withCastSound(new SoundInstance(SoundEvents.ENTITY_SKELETON_STEP, 1.0F, SoundInstance.DEFAULT_PITCH))
                    .withRetrieveSound(new SoundInstance(SoundEvents.ENTITY_SKELETON_STEP, 0.5F, SoundInstance.DEFAULT_PITCH)).lavaProof(true).build());

    public static final Item DIAMOND_REINFORCED_ROD = register("diamond_reinforced_rod", new ExtendedFishingRodItem.Builder().durability(300).color(Formatting.AQUA).lavaProof(true).build());

    public static final Item EYE_OF_FISHING = register("ender_rod", new ExtendedFishingRodItem.Builder().durability(250).color(Formatting.LIGHT_PURPLE).build());

    public static final Item FROSTED_ROD = register("frosted_rod", new ExtendedFishingRodItem.Builder().durability(150).build());

    public static final Item SLIME_ROD = register("slime_rod",
            new ExtendedFishingRodItem.Builder().durability(150).color(Formatting.GREEN).withCastSound(new SoundInstance(SoundEvents.ENTITY_SLIME_JUMP, 0.8F, SoundInstance.DEFAULT_PITCH))
                    .withRetrieveSound(new SoundInstance(SoundEvents.ENTITY_SLIME_JUMP, 0.5F, SoundInstance.DEFAULT_PITCH)).build());

    public static final Item SOUL_ROD = register("soul_rod", new ExtendedFishingRodItem.Builder().durability(250).color(Formatting.LIGHT_PURPLE).baseExperienceGain(5).lavaProof(true).build());

    public static final Item MATRIX_ROD = register("matrix_rod", new ExtendedFishingRodItem.Builder().durability(200).color(Formatting.LIGHT_PURPLE).build());

    public static final Item CELESTIAL_ROD = register("celestial_rod", new ExtendedFishingRodItem.Builder().durability(150).color(Formatting.LIGHT_PURPLE).tooltipLines(1).build());
    ...
    public static final Item ICICLE_FISH = register("icicle_fish",
            new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(2).statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE, 0, 0), 1).build())));
    ...
    public static final Item SLIMEFISH = register("slimefish",
            new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.25f).statusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 20 * 5, 0), 1).build())));
    ...
    public static final Item CHARFISH = register("charfish",
            new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(2).statusEffect(new StatusEffectInstance(StatusEffects.BLINDNESS, 20 * 5, 0), 1).build())));
    ...
    public static final Item GRILLED_BLACKSTONE_TROUT = register("grilled_blackstone_trout",
            new TooltippedItem(new Item.Settings().food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8f).build()).fireproof(), 2));
    public static final Item GRILLED_BLACKSTONE_DELUXE = register("grilled_blackstone_deluxe",
            new TooltippedItem(new Item.Settings().food(new FoodComponent.Builder().hunger(11).saturationModifier(0.8f).build()).fireproof(), 3));
    public static final Item BONEFISH = register("bonefish", new Item(new Item.Settings().fireproof()));
    public static final Item GILDED_BLACKSTONE_CARP = register("gilded_blackstone_carp",
            new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.5f).build()).fireproof()));
    public static final Item SMOKEY_SALMON = register("smokey_salmon", new Item(new Item.Settings()
            .food(new FoodComponent.Builder().hunger(6).saturationModifier(0.5f).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20 * 15, 0), 1).build()).fireproof()));
    ...
    public static final Item MAGMA_COD = register("magma_cod", new Item(new Item.Settings()
            .food(new FoodComponent.Builder().statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20 * 15, 0), 1).hunger(6).saturationModifier(0.5f).build()).fireproof()));
    ...
    public static final Item ENDFISH_AND_CHORUS = register("endfish_and_chorus",
            new TooltippedItem(new Item.Settings().food(new FoodComponent.Builder().hunger(8).saturationModifier(1f).build()), 2));
    ...
    public static final Item AQUATIC_ASTRAL_STEW = register("aquatic_astral_stew",
            new TooltippedItem(new Item.Settings().food(new FoodComponent.Builder().hunger(9).saturationModifier(0.75f).build()), 3));
    ...
    public static final Item THUNDERING_BASS = register("thundering_bass",
            new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(5).saturationModifier(0.75f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 15 * 20), 1).build())));
    ...
    public static <T extends Item> T register(String name, T item) {
        ItemGroupEvents.modifyEntriesEvent(GOFISH_ITEM_GROUP).register(entries -> entries.add(item));
        return Registry.register(Registries.ITEM, GoFish.id(name), item);
    }

    public static void init() {
        Registry.register(Registries.ITEM_GROUP, GOFISH_ITEM_GROUP, FabricItemGroup.builder().icon(() -> new ItemStack(GOLDEN_FISH)).displayName(Text.translatable("itemGroup.gofish.group")).build());
    }
}
